...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV16ia6epENY?p=82)
...
### 3.1.1技术可行性
本在线宠物用品交易网站采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
|shiyongchongwu|varchar(200)|是|NULL|适用宠物|
|pinpai|varchar(200)|是|NULL|品牌|
|guige|varchar(200)|是|NULL|规格|
|yuexiaoliang|int(11)|是|NULL|月销量|
